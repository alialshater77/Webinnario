...
<div id="grid" style:display="grid" style:gap="0.2em" style:width="100%">
	{#each answers as { correct, content, id }, index (id)}
		<div transition:scale={{ easing: backOut, duration: 300 }} animate:flip={{ duration: 300 }} style:display="flex" style:justify-content="center">
			<Answer
	...
	{#if answers.length < limits.fuiz.multipleChoice.maxAnswerCount}
		<div style:grid-column="1/ -1" transition:scale={{ easing: backOut, duration: 300 }} class="add-answer">
			<FancyButton
